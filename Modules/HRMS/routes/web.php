...
//pre-processing Routes
  ...
  //offer letter route
  Route::get('hrms/offer-letter', [FinalSelectionController::class, 'index'])->name('offerLetter.generate');
  Route::get('hrms/offer-letter-view/{id}', [FinalSelectionController::class, 'viewOfferLetter'])->name('offerLetter.view');
